...
如果你也在寻找更智能、更集成的代码质量解决方案，欢迎一起交流探讨。`,
  },
  {
    ...
    excerpt:
      'CoStrict团队的运营Connie用CoStrict CLI写了一个运营活动的交互页面，作为非研发人员，她花了1个小时做出了一个达到上线要求的页面，并获得了团队交互设计师、前端工程师的一致点赞。',
    author: 'Connie',
    authorInitial: 'C',
    cover: 'case',

    content: `近期，CoStrict团队的运营Connie用CoStrict CLI写了一个运营活动的交互页面，体验丝滑，且与CoStrict官网风格十分一致。
...
![AI辅助运营工作流](/blog-images/operation-page/image2.png)
...
![初版提示词](/blog-images/operation-page/image3.png)
