...
export const CLI_COMMAND_INSTALL_CURL_BASH =
  'curl -fsSL https://raw.githubusercontent.com/costrict/cli/main/install.sh | bash'
export const CLI_COMMAND_INSTALL_CURL_POWERSHELL =
  'irm https://raw.githubusercontent.com/costrict/cli/main/install.ps1 | iex'
